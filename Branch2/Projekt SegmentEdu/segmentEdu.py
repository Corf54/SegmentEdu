...
game = Game()								# Stworzenie instancji gry ; wraz z setupem

# ----------- Main Program Loop / Glowna Petla Programu ------------
while game.run == True:
	
	game.first__events(game.mode,game.object_dict,game.run)	# Event processing 	/ Czesc 1. - Przetwarzanie wydarzen
	
	game.second__logic(game.object_dict)							# Game logic 			/ Czesc 2. - Przetwarzanie logiki gry
...
pygame.quit()		# Wylaczenie silnika i gry
